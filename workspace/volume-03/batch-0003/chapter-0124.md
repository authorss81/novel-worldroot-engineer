...
There is one thing left in that woman's keeping that this fen has asked about, and it is not the fragment, and on the twenty-first of this month at about the ninth hour she was asked about it in a yard in the ordinary way and she answered in four sentences and the four sentences are all anybody is going to get.
...
"Three sentences is a refusal with a reason in it," said Dunmar Fitch, from the gate, writing. "The fourth is a limit. **May it be entered that the fourth was said first in the speaking and last in the writing, and that the woman asked for it to be written last.**"

"Enter it," she said. "Enter every part of it in the order I said it and not in a better order."
...
She did not say that it was wrong. She said nothing at all for about four seconds, and then she said one sentence, and the clerk entered it and read it back and the reader read it back after him and nobody thanked anybody.

"I am not going to confirm it and I am not going to deny it," she said. "**A confirmation from me is a document and a denial from me is a document, and I have not made a document in nineteen years and I am not starting with you.**"

And the fen entered the fact, and the fen entered with it the sentence that goes with it, and Lissa Vale wrote that sentence and it is the hardest line in this body's book for the reason that follows.

> Entered at the ninth hour of the twenty-first of this month: **the person who spoke in this building on the seventeenth of this month is the only living person who knows what is in the compensation record.** Entered on the word of the reader of this body and not on any other. It was not confirmed and it was not denied. **The speaker has declined to confirm it and has declined to deny it, and a confirmation and a denial would both be documents, and she has made none in nineteen years.**
>
> **A body cannot check this and cannot ask for it and cannot cite the fact that it exists without making a claim it cannot support.** The word *only* on that line is the word doing the damage. It is a word about every other person in the world, and this body has standing over nobody outside this holding except the sixteen households that pay a shilling a month, and one of those is not a body and the other fifteen have never heard of it.
>
> The line stands. It is entered as a fact about a day and not as a finding, and the cost of it is entered with it, and the cost is that it grows.

And that last of those is the difference, and the fen entered it as the difference, because the man of about seventy entered it four hours later and the fen would not have got there on its own.

---

And then the thing nobody in that yard asked, and the fen entered it whole, with the hour, and it is the third time this body has entered that sentence and the count is now three and the count is in the book because a body that keeps a count of a silence is a body that knows it is keeping one.

> Entered at the ninth hour of the twenty-first of this month, in the yard, by the clerk:
>
> **The question of what her life was like afterwards was available to anybody in that yard at every hour of that day and was taken by nobody.**
>
> The question was available to the reader of this body, who has asked four questions in a yard this season that nobody in this holding wanted to answer. It was available to the seedwright, who has said a sentence about a free offer with a signature attached and has never said where she read it. It was available to the man of about seventy, who was not brought out and would have been brought out.
>
> **It was taken by nobody and it is not going to be taken. This is the third time this fen has entered that sentence. The first was at a stack against a north wall four hundred miles off. The second was in a yard about a day letter. This is the third, and the count is entered, and the count is the only new thing in it.**
...
And the fen entered that he noticed it and did not enter what it was, and the man of about fifty read that back, and asked for his initial to be put against nothing, and nobody thanked anybody.
...
And Dunmar Fitch read all of that back, and the reader read it after him, and the fen entered that the examiner's standing cannot be exercised on anything the body is now holding, and that a body whose only check on a thing is a person hearing it before it goes in has been holding four things for a week without a check, and that the standing is not withdrawn and is not going to be.

Underneath the day's work, dated the twenty-second, signed by nobody but Marek, and read back before it was initialled, is the thirty-fourth note under section nine of the charter schedule, and there is no charter, and the note says so on its face.

*A compensation record named as sealed and not opened, held by an office whose name is at the head of a district's index of relay designs and is not said out loud in a yard, with people in it by name whose names are not on the page and are not going to be on the page, and the reason entered, which is that this fen has no standing over any of them and the speaker has none either. A fourth sentence asked for last in the writing and given last in the speaking. A question that was available to everybody in that yard and taken by nobody, and the count of how many times this fen has entered that sentence now entered as the only new thing in it, which is three. The reader of this body standing at a gate saying that a record nobody can produce cannot corroborate a statement and cannot be used to attack one, and that this is a wall on both sides, and that it is the same wall as the part three condition and the same wall as the shape the schedule has no part for, and that this body has now built three of them in three weeks and every one of them is correct. The man of about seventy on the difference between a wall that is held and a wall that grows, and on a fourth one coming with no name and no number and no day, and the fen entering that he noticed it and not entering what it was. And the examiner reading out in a yard the four things this body is holding in the order they came in, none of them a document, and saying out loud that the one standing this holding has for checking a thing cannot be exercised on any of them, and that the standing is not withdrawn.*
