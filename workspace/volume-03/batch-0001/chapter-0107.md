...
> District office at the foot of the plateau. Schedule of records held, fourth part. Return for a body or a person holding rootwork records, whether bound or unbound, on ground in this district or on ground in another district where the work was done.
>
> One. Records of rootwork are held by this office in a schedule. Every holder of a rootwork record is asked to return an inventory of it. An inventory is a list, and a list is not a copy, and a holder who returns a list has not given anything away.
>
> Two. A record of rootwork falls into a part. Part one, a record of a work done and its result. Part two, a record of a work done and its reading. Part three, a record of a work done, its reading, and a direction given to another person.
>
> Three. **Part three records are held under a standing condition that they are unfit for evidentiary use.** They are held so that a holder may be told what exists and may not cite what exists. They may not be produced in any proceeding, in any letter, in any inventory return, or in any dispute between one holder and another. A part three record exists and does not count, and the condition is not a judgment and there is no officer of this district who may remove it, and the condition was set at the establishment of this schedule and is not a matter of opinion.
>
> Four. A holder who cannot classify a record may state that in the return. **A statement that a holder cannot classify a record is itself a classification, and the record is then held under part three.**
>
...
Tova Reed read all three back, including the reason for the reading, which she has done twice in a season and does not do as a courtesy, and then she asked the one question, and she asked it in a yard in daylight with nine people in it.
...
And then the offer, which is the real thing, and it is free, and it is on the covering letter, and it is the third point of a rider and it is nine miles from a form.
...
And she went down the road at about the sixth hour and the cart went with her and the yard stood there.
